...
class Playlist(ctk.CTkFrame):
    ...
    def GetPlaylistDisp(self):
        ...
        if data==[]:
            ...
            for s in data:
                P_PlaylistDisp(self.scroll, s[0], s[1], s[2], self.pi, self.conn, self.cursor, on_open=self.OpenPlaylist)
...
class P_PlaylistDisp(ctk.CTkFrame):#
    def __init__(self, master, PlaylistSno, PlaylistName, CoverDir, engine, qdb, pi, conn, cursor, on_open=None):
        super().__init__(master)
